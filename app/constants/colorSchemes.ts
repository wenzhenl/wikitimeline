...
export const COLOR_SCHEMES: ColorScheme[] = [
  {
    ...TAILWIND_CLASSES,
    colors: Object.entries(TAILWIND_CLASSES.colors).reduce(
      (acc, [key, value]) => {
  ...
  {
    ...NATURE_CLASSES,
    colors: Object.entries(NATURE_CLASSES.colors).reduce(
      (acc, [key, value]) => {
        acc[key as unknown as number] = {
          color: getColorFromClass(value.color),
          textColor: getColorFromClass(value.textColor),
  ...
  {
    ...VIBRANT_CLASSES,
    colors: Object.entries(VIBRANT_CLASSES.colors).reduce(
      (acc, [key, value]) => {
        acc[key as unknown as number] = {
          color: getColorFromClass(value.color),
          textColor: getColorFromClass(value.textColor),
  ...
  {
    ...MONOCHROME_CLASSES,
    colors: Object.entries(MONOCHROME_CLASSES.colors).reduce(
      (acc, [key, value]) => {
        acc[key as unknown as number] = {
          color: getColorFromClass(value.color),
          textColor: getColorFromClass(value.textColor),
